 ...
 * Return Type  : void
 */
void test_code_style_api(const mxArray * const prhs[1], int32_T nlhs, const
  mxArray *plhs[1])
{
  real_T x;
 ...
 * Return Type  : void
 */
void test_code_style_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
